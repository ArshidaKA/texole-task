...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-end justify-center p-2   ">
      <div className="w-full lg:h-[84vh] flex flex-col justify-around items-center gap-24 lg:gap-0 bg-[var(--background)]">
        <div className="text-center">
          <h1 className="text-[48px] md:text-[75px] font-bold tracking-wide text-gray-900 relative inline-block">
            ...
            <span className="relative inline-block z-20">
              TSEEP Mastery Box
              <span className="absolute left-0 md:bottom-6 bottom-4 w-full h-3  bg-[var(--secondary) z-[-1]"></span>
            </span>
          </h1>
